# Archived sections — wave-6-error-codes.md

> Sections excised verbatim from `.claude/rules/project/wave-6-error-codes.md`
> on 2026-07-20 (context-size incident). Live file keeps a pointer per section.


<!-- ==== AGGREGATOR-LATE-01 body (emit sites deleted 2026-07-17; variant retained; historical audit) ==== -->
...
<!-- ==== BOUNDARY-01 body (emit sites deleted 2026-07-17; variant retained; historical audit) ==== -->
...
<!-- ==== AGGREGATOR-LAG-01 body (emit sites deleted 2026-07-17; variant retained; historical audit) ==== -->
