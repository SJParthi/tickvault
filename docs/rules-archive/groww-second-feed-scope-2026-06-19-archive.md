# Archived sections — groww-second-feed-scope-2026-06-19.md

> Sections excised verbatim from `.claude/rules/project/groww-second-feed-scope-2026-06-19.md`
> on 2026-07-20 (context-size incident). Live file keeps a pointer per section.


<!-- ==== §0 verbatim operator demands + §1 the rule (retired live-feed contract, 2026-07-15) ==== -->
...
<!-- ==== §5 honest envelope + §6 auto-driver (retired live-feed guarantees) ==== -->
...
<!-- ==== §32 Python-SDK sidecar path, §33 LIVE-FEED-ONLY lock, §34 multi-connection auto-scale, §35 native-Rust shadow client (all retired with the Groww live feed 2026-07-15) ==== -->
