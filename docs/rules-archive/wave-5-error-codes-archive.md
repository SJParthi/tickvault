# Archived sections — wave-5-error-codes.md

> Sections excised verbatim from `.claude/rules/project/wave-5-error-codes.md`
> on 2026-07-20 (context-size incident). Live file keeps a pointer per section.


<!-- ==== DEPTH-20-DYN-03 + DEPTH-200-DYN-01 (RETIRED 2026-07-06 — movers runtime deleted 2026-05-19; variants deleted; historical audit) ==== -->
...
<!-- ==== VOLUME-MONO-01 body (emit site deleted 2026-07-17; variant retained; historical audit) ==== -->
...
<!-- ==== DEPTH200-SMOKE-01 + PHASE2-READY-01 (subsystems deleted — depth-200 feeds 2026-05-19, Phase 2 dispatcher 2026-05-19; ErrorCode variants no longer exist; historical audit) ==== -->
