...
> **[ARCHIVED 2026-07-20]** DEPTH-DYN-01 + DEPTH-DYN-02 (RETIRED 2026-07-06 — movers runtime deleted 2026-05-19; ErrorCode variants deleted; historical audit) — moved verbatim to `docs/rules-archive/wave-4-error-codes-archive.md` (context-size incident; content unchanged).
...
> **[ARCHIVED 2026-07-20]** AUTH-GAP-06 body (module deleted 2026-07-14; variant retained until the C4 sweep; historical audit) — moved verbatim to `docs/rules-archive/wave-4-error-codes-archive.md` (context-size incident; content unchanged).
