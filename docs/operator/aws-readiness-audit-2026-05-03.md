...
| 14 | **LOW** | Prod SSM path tree (10 paths) **fully wired** in `secret_manager.rs:525-750`. Includes Dhan, Telegram, QuestDB, Grafana, API, Valkey. | `crates/core/src/auth/secret_manager.rs:525,529,533,610,633,637,661,665,687,750` | None — provision the actual SSM parameters before AWS deploy, but the code path is ready. |
