...
| ------------------------------------------------------------------ | ---------- | ----------------------------------------------------------------------- |
| [Exchange Segment ENUM](./18-annexure.md#exchange-segment)   *required* | array | Security ID - can be found in [Instrument List](./21-instruments-scrip-master.md) |

(The request body is a JSON object keyed by Exchange Segment enum, each mapping to an array of Security IDs.)
...
| last\_trade\_time     | string | Last traded quantity (sic — last traded time)          |
