...
| Field                     | Description                    |
| ------------------------- | ------------------------------ |
| app\_id     *required*    | API Key generated from Dhan    |
| app\_secret    *required* | API Secret generated from Dhan |
...
| Field                         | Description                     |
| ----------------------------- | ------------------------------- |
| partner\_id     *required*    | Partner ID provided by Dhan     |
| partner\_secret    *required* | Partner Secret provided by Dhan |
