# Groww Trade API — Introduction (Auth, Getting Started)
...
For [Live feed](/trade-api/docs/python-sdk/feed), upto 1000 subscriptions are allowed at a time.

[Next

Instruments](/trade-api/docs/python-sdk/instruments)
