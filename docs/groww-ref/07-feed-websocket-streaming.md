# Groww Trade API — Feed — WebSocket Streaming (LTP / Index / Depth / Order & Position Updates)
...
| exchange\_token | str | Exchange token of the equity or derivative as provided in instrument csv. |
...
| exchange | str | [Stock Exchange](/trade-api/docs/python-sdk/annexures#exchange) |
| segment | str | [Segment](/trade-api/docs/python-sdk/annexures#segment) of the instrument such as CASH, FNO etc. |
| feed\_type | str | The type of feed data (e.g., ltp, order\_updates, position\_updates). |
| feed\_key (Exchange token) | str | A unique identifier for the feed topic. |
...
Backtesting](/trade-api/docs/python-sdk/backtesting)[Next

User](/trade-api/docs/python-sdk/user)
