...
5. **Pre-live prerequisites (flagged, not shipped in Cluster B):** the
   ...
   probe burst), a 7,000/day budget tracker (**2026-08-22: the `DailyRequestTracker` named here never existed. Superseded by `OrderBudget`, which enforces the vendor's real published tiers — 250/min, 1000/hr, 7000/day — beside the per-second GCRA.**), and
