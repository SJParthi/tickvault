...
|---|---|---|
| 100% code coverage | `quality/crate-coverage-thresholds.toml` ratcheted per-crate floors (72.6–99.4, target 100%), floors only move up | `scripts/coverage-gate.sh` in CI |
