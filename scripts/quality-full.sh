...
#   6. Coverage    — cargo llvm-cov --workspace --fail-under-lines 99
# =============================================================================
...
if command -v cargo-llvm-cov > /dev/null 2>&1; then
    run_stage "6/6" "Coverage (99% min)" "cargo llvm-cov --workspace --fail-under-lines 99 --html --output-dir target/llvm-cov"
else
    echo -e "${CYAN}[Stage 6/6]${NC} Coverage"
    echo -e "  ${YELLOW}SKIPPED${NC} — cargo-llvm-cov not installed"
    echo ""
fi
