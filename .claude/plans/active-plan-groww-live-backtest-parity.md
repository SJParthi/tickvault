...
- [ ] SP4 — `GenericCandle1mWriter(feed)` merging the two writers (IN PROGRESS). Files: `crates/storage/src/shadow_candle_writer.rs`, `crates/storage/src/groww_candle_persistence.rs` (merge).
