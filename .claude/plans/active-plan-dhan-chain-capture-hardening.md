...
- [ ] Item 1 — Bounded same-key retry + 15s decision ceiling on the chain fire (concurrency KEPT per the Dhan doc)
...
- [ ] Item 2 — Dhan UnderlyingServedTracker + typed HIGH page (mirror #1537) + noise-lock §2/§2.1/§4 edit
...
- [ ] Item 3 — strikes/legs histograms + log-only ladder-shrink watermark
...
- [ ] Item 4 — loud trading-day-flip exits (3 sites, both Dhan legs)
...
- [ ] Item 5 — rule files: new cross-source-chain-coverage-2026-07-14.md + rest-1m §2c end pointer paragraph
