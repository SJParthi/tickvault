...
- [ ] Fix TopMoversTracker to use prev_close from PrevClose packets instead of tick.day_close
...
- [ ] Fix OptionMoversTracker to use prev_close from PrevClose packets instead of tick.day_close
...
- [ ] Wire IndicatorSnapshotWriter into trading_pipeline to persist indicator snapshots every 60 seconds
...
- [ ] Add flush on shutdown for stock_movers_writer and option_movers_writer in tick_processor
