...
**Evidence base:** `deploy/aws/lambda/questdb-console-proxy/repro-evidence.md` (QuestDB 9.3.5 framing repro, 2026-07-06 — §9a/§9c/§10 cited throughout; COMMITTED verbatim in fixer round 7 2026-07-06 — the earlier session-scratchpad path was a dangling reference for readers of HEAD, charter §4 evidence discipline)
