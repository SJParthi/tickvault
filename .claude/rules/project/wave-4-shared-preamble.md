...
|---|---|
| Code coverage | `quality/crate-coverage-thresholds.toml` ratcheted per-crate floors (72.6–99.4, target 100%), floors only move up; enforced post-merge by `scripts/coverage-gate.sh` |
