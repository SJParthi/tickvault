...
- Disk envelope (honest): `option_chain_1m` ≈ ~337K rows ≈ ~70 MB/day at ~150 strikes ≈ ~6.3 GB/90d (~21% of the 30 GB EBS — *2026-07-19 correction: live root verified 30 GiB by `describe-volumes`; the 2026-07-13 approved 30→50 grow was recorded but never physically applied — see `daily-universe-scope-expansion-2026-05-27.md` §7; this line read "50 GB since 2026-07-13" until 2026-07-19*) — retention/partition-manager registration is a flagged follow-up in the code PRs; `spot_1m_rest` is trivial (~1,125 rows/day).
