...
> **⚠ FUTIDX-4 EXTENSION 2026-07-08 by [`daily-universe-scope-expansion-2026-05-27.md`](./daily-universe-scope-expansion-2026-05-27.md) §36:** the single Dhan main-feed conn additionally subscribes 4 nearest-expiry index-futures contracts (NIFTY/BANKNIFTY/MIDCPNIFTY = NSE_FNO, SENSEX = BSE_FNO; Quote mode; NEVER rolls intraday), and the Groww watch set gains the SAME 4 logical contracts on its existing single connection. The 2-WS lock is UNCHANGED. The "NSE_EQ / NSE_FNO / BSE_FNO / MCX / currency subscriptions" forbidden row below is carved down to "…except the 4 §36 FUTIDX contracts (NSE_FNO ×3 + BSE_FNO SENSEX future)". Operator verbatim 2026-07-08: *"for both dhan and groww we need to add futures and those also should be subscribed along with this, especially only for nifty banknifty and sensex nifty midcap."*
