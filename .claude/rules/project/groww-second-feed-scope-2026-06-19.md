...
> **[ARCHIVED 2026-07-20]** §0 verbatim operator demands + §1 the rule (retired live-feed contract, 2026-07-15) — moved verbatim to `docs/rules-archive/groww-second-feed-scope-2026-06-19-archive.md` (context-size incident; content unchanged).
...
> **[ARCHIVED 2026-07-20]** §5 honest envelope + §6 auto-driver (retired live-feed guarantees) — moved verbatim to `docs/rules-archive/groww-second-feed-scope-2026-06-19-archive.md` (context-size incident; content unchanged).
...
> **[ARCHIVED 2026-07-20]** §32 Python-SDK sidecar path, §33 LIVE-FEED-ONLY lock, §34 multi-connection auto-scale, §35 native-Rust shadow client (all retired with the Groww live feed 2026-07-15) — moved verbatim to `docs/rules-archive/groww-second-feed-scope-2026-06-19-archive.md` (context-size incident; content unchanged).
