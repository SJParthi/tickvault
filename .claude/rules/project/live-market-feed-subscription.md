...
## 2026-07-08 Update — FUTIDX-4 nearest-expiry subscription (daily-universe §36)

Per the operator authorization recorded in `daily-universe-scope-expansion-2026-05-27.md` §36
(2026-07-08), the daily-universe plan additionally subscribes the 4 nearest-expiry FUTIDX
contracts for NIFTY / BANKNIFTY / MIDCPNIFTY (NSE_FNO) + SENSEX (BSE_FNO) in Quote mode on the
