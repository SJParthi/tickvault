...
7. **Applicable-F&O master vs subscription set (lock §5, operator Quote 5
   ...
   **WebSocket subscription is the 331-SID indices+spots subset plus the 4 §36 nearest-expiry
   FUTIDX contracts (2026-07-08, promoted into `subscription_targets` at build time)** — the
