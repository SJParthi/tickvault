...
/// Boot wiring for the daily cross-verification: its own task, the S3
/// archive gate's marker, and restart catch-up (§12.15, 2026-09-24).
pub mod dhan_live_crossverify_boot;
