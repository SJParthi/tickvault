...
///
/// PR #457 (2026-05-04): array length corrected `14` → `16`. PR #444
/// retired `preopen_movers` (decrement to 13) but PRs #449/#450 added
/// `depth_dynamic_top_volume`, `depth_dynamic_pipeline_v2`,
/// `historical_fetch_enabled` (back to 16) without updating this list
/// — pre-existing drift that blocked the build when `cargo test
/// -p tickvault-app --tests` compiled this file.
