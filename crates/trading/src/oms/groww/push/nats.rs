//! Native NATS wire-protocol framing for the Groww order/position push
//! channel — zero new deps. Restored byte-faithful (2026-07-16, order-push
//! Stage B) from the retired live-feed transport
//! (`dd7eaa5e^:crates/core/src/feed/groww/nats.rs`), where it was merged +
//! fully tested.
//!
//! Groww's push channel is NATS-over-WebSocket: each WebSocket frame carries NATS
