...
///
/// TrueData (feed #4) declares `Symbol Id`, `Time stamp`, `Volume`,
/// `Sequence No`, `Bid Qty` and `Ask Qty` as SIGNED 4-byte ints in the
...
/// Reads a little-endian i64 from a byte slice at the given offset.
///
