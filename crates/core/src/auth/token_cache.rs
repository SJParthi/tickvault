...
// Dead-code batch 2 (2026-07-18): `FastCacheResult` + `load_token_cache_fast`
// DELETED — the FAST crash-recovery boot arm died in PR-C2 + the 2026-07-14
// noise lock; zero production callers remained.
