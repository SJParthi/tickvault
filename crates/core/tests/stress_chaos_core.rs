...
// ===========================================================================
// stress_subscription_builder — RETIRED (PR-C2, 2026-07-13).
// The 13 subscribe-JSON stress tests died with the functionality they pinned:
// `subscription_builder.rs` was DELETED with the Dhan live main-feed WS lane
// (operator retirement directive — websocket-connection-scope-lock.md
