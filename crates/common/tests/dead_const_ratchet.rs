...
const DEAD_CONST_ALLOWLIST: &[&str] = &[
    ...
    "GROWW_NATIVE_RECONNECT_BASE_SECS",
    "GROWW_NATIVE_RECONNECT_MAX_SECS",
    "GROWW_NATIVE_WATCH_POLL_SECS",
    "GROWW_NATIVE_WRITER_CHANNEL_CAPACITY",
    "GROWW_ORDER_EOD_SWEEP_IST",
    "GROWW_ORDER_LEDGER_DIR",
    "GROWW_ORDER_RECONCILE_IDLE_INTERVAL_SECS",
    "GROWW_ORDER_RECONCILE_INTERVAL_SECS",
