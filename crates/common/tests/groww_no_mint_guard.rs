...
// The sidecar / smoke-script / requirements pins were RETIRED 2026-07-15 —
// scripts/groww-sidecar/ was deleted with the Groww live feed (operator
// directive: REST legs only). The no-mint scans above + the Rust-reader pin
// below are the SURVIVING token-minter-lock ratchets.
